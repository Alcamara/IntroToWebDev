...
function combine(array1, array2) {
  ...
  let newArray = [];
   ...
   for(let position = 0; position < array1Len; position++){
     newArray.push(array1[position]);
   }

   for(let position = 0; position < array2Len; position++){
     newArray.push(array2[position]);
   }
